...
public class Player {
    ...
    public Tangible removeItem(Tangible item) {
        //TODO Complete this function in Sprint 3 Module 3
        Tangible returnItem = backpack.getItem(item.getName());
    ...
    /**
     * Adds a key to the backpack.
     * @param item the key that needs to be added.
     */
    ...
    /**
     * Finds a key in the backpack and returns it.
     * @return the key that is returned.
     */
